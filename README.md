...
I mostly work on full-stack web apps with React and AWS — been really into serverless lately. Also dabble in embedded systems when I get the chance.
...
**Think Fast!** — trivia game I built with a team using Raspberry Pi and Arduino. Physical buttons, LED feedback, the whole thing. Was a fun change from web dev.

## Tech I use

JavaScript, Python, Java, C, C++, React, Node.js, AWS (Lambda, DynamoDB, S3, CloudFront, EC2), Docker, Git
